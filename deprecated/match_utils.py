"""
Original code: https://github.com/rao1140427950/ssd_keras/blob/master/ssd_encoder_decoder/matching_utils.py
...
def match_bipartite_greedy(weight_matrix):
    ...
    Arguments:
        weight_matrix (np.array): A 2D Numpy array that represents the weight matrix
