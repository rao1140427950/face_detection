...
Original code:
https://github.com/rao1140427950/ssd_keras/blob/master/bounding_box_utils/bounding_box_utils.py
"""
...
def convert_coordinates(tensor, start_index, conversion, border_pixels='half'):
    ...
    if border_pixels == 'half':
        ...
        raise ValueError("Unsupport value: 'border_pixels' = {}.".format(border_pixels))
    ...
    if conversion == 'minmax2centroids':
        ...
        raise ValueError("Unexpected conversion value. Supported values are 'minmax2centroids', \
...
def intersection_area(boxes1, boxes2, coords='centroids', mode='outer_product', border_pixels='half'):
    ...
    if border_pixels == 'half':
        ...
        raise ValueError("Unexpected value for `border_pixels`.")
